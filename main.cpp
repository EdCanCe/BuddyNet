...
int main(){
    ...
    std::cout<<screen.center(screen.text.style.bold(screen.text.color.blue( posteo.getAuthor().getName())) + " - " + screen.text.color.blue("@"+posteo.getAuthor().getUsername()))<<"\n";
    std::cout<<screen.center(posteo.getText())<<"\n";
